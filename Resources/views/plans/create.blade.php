...
@section('content')
<form method="POST" action="{{ route('memberships.plans.store') }}">
    @csrf
    ...
    <div x-data="{
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="price" class="form-control" min="0" step="0.01" value="{{ old('price', $plan->price ?? 0) }}" required>
                </td>
            </tr>
        </table>
        ...
        <table class="table">
            ...
            <tr x-show="permanent == 0">
                ...
                <td>
                    <input type="number" name="invoice_period" class="form-control" min="1" value="{{ old('invoice_period', $plan->invoice_period ?? 1) }}" required>
                </td>
            </tr>
        ...
        <table class="table" x-show="permanent == 0">
            ...
            <tr x-show="hasTrial == 1">
                <td>Varighed</td>
                <td>
                    <input type="number" name="trial_period" class="form-control" min="1" value="{{ old('trial_period', $plan->trial_period ?? 7) }}" required>
                </td>
            </tr>
        ...
        <table class="table">
            ...
            <tr>
                <th colspan="2">Grace-periode</th>
            </tr>

            <tr>
                <td width="200">Ophørstid efter udløb</td>
                <td>
                    <input type="number" name="grace_period" class="form-control" min="0" value="{{ old('grace_period', $plan->grace_period ?? 7) }}" required>
                </td>
            </tr>
        ...
        {{-- HANDLINGER --}}
        <div class="mt-3">
            <button type="submit" class="btn btn-primary">Opret Plan</button>
